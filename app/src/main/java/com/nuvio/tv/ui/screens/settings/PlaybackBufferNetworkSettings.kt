        ...
        if (playerSettings.useParallelConnections) {
            item(key = "buffer_net_parallel_connection_count") {
                SliderSettingsItem(
                    ...
                    maxValue = if (playerSettings.nuvioPerformanceModeEnabled && !MemoryBudget.isConstrainedTier) 16 else MemoryBudget.MAX_CONNECTIONS,
                    step = 1,
            ...
            item(key = "buffer_net_parallel_chunk_size") {
                ...
                val maxChunkSizeMb = if (playerSettings.nuvioPerformanceModeEnabled && !MemoryBudget.isConstrainedTier) {
