    ...
    scope.launch {
        try {
            ...
            val loadControl = if (playerSettings.nuvioPerformanceModeEnabled) {
                ...
                val backBufferMsAtBuild = if (libdoviConversionActive && MemoryBudget.isConstrainedTier) {
                    0
                } else {
...
private fun PlayerRuntimeController.recordFirstFrameDiagnostics(
    ...
    currentBitrateAwareLoadControl?.let { lc ->
        ...
        val keepZeroForDv7 = conversionSucceeded > 0L && MemoryBudget.isConstrainedTier
