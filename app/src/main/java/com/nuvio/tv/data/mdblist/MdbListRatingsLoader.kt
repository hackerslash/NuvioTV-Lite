...
internal class MdbListRatingsLoader(
    ...
    // Bounded: every rated card on every row lands here and a TTL alone never drops the old ones.
    private val cache = lruCacheMap<RequestKey, CacheEntry>(MAX_CACHE_ENTRIES)
